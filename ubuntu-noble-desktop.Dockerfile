...
RUN apt update && apt install -y sudo curl jq wget build-essential python3 python3-pip iptables ip6tables wireguard resolvconf jq libfuse2 libxi6 libxrender1 libxtst6 mesa-utils libfontconfig libgtk-3-bin
